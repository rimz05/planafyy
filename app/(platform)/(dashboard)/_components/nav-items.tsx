  ...
  return (
    <div>
      ...
      className="border-none">
        ...
        className={
            cn("flex w-full items-center gap-x-2 p-1.5 left-0 text-neutral-700 rounded-md hover:bg-neutral-500/10 transition text-star no-underline hover:no-underline",
